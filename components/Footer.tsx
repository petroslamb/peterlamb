      ...
      <div className="container mx-auto py-6 px-4 sm:px-6 lg:px-8 text-center text-sm text-text-secondary dark:text-slate-400">
        <nav aria-label={translations.ariaLabels.socialNav} className="mb-4">
            <ul className="flex justify-center space-x-6">
                <li>
                    <a
                        href="mailto:petroslamb.dev@gmail.com"
                        className="hover:text-primary dark:hover:text-cyan-400 transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary rounded-sm"
                        aria-label="Email"
                        onClick={() => trackEvent('footer_social_click', { channel: 'email' })}
                    >
                ...
                <li>
                    <a
                        href="https://linkedin.com/in/petroslamb"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="hover:text-primary dark:hover:text-cyan-400 transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary rounded-sm"
                        aria-label="LinkedIn"
                        onClick={() => trackEvent('footer_social_click', { channel: 'linkedin' })}
                    >
                ...
                <li>
                    <a
                        ...
                        className="hover:text-primary dark:hover:text-cyan-400 transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary rounded-sm"
                        aria-label="GitHub"
                        onClick={() => trackEvent('footer_social_click', { channel: 'github' })}
                    >
